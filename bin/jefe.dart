...
main(List<String> arguments) {
  ...
  runner..addCommand(Install())..addCommand(Init())..addCommand(
      Jefetise())..addCommand(Start())..addCommand(Finish())..addCommand(
      Exec())..addCommand(SetDependencies())..addCommand(Test());
