...
class GitCommandsImpl implements GitCommands {
  ...
  @override
  ProjectCommand assertWorkingTreeClean() => projectCommand(
      'git assertWorkingTreeClean', (Project p) async {
  ...
  ProjectCommand updateFromRemote(String branchName,
      [String remoteName = 'origin']) => projectCommand(
          'git update from remote: $branchName', (Project p) async {
  ...
  @override
  ProjectCommand merge(String commit) => projectCommand('git merge $commit',
      (Project p) async {
